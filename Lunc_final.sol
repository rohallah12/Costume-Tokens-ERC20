...
contract Lunc is ERC20, Ownable {
    ...
    constructor() ERC20("Lunc", "Luncp") {
        ...
        pancakeRouter = DexRouter(0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0);
    ...
    function manageTaxes() internal {
        ...
        //we will also calculate this amount of stuck tokens and add it to marketing wallet
        uint256 stuckAmount = balanceOf(address(this)) - (makretingPortion + burnPortion + rewardPortion);
        ...
        distributor.deposit(rewardPortion);
        
        //sending to marketing wallet
        swapToBNB(makretingPortion + stuckAmount);
